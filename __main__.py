...
# for this demo we're going to use this group
...
# to debug, use pulumi.export, in this case we're only returning contract_id
# pulumi.export("output", contract_id)
